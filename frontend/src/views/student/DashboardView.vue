  ...
  <div class="container">
    ...
    <v-card class="table">
      <v-row>
        ...
        <v-col>
          <v-btn color="primary" dark v-on:click="show = 'Failed'" data-cy="FailedAnswersButton"
            >Failed Answers <br />
            {{
        ...
        >
        <v-col>
          <v-btn color="primary" dark v-on:click="show = 'Difficult'" data-cy="difficultQuestionsMenuButton"
    ...
    <div v-if="show === 'Failed'" class="stats-container">
      <failed-answers-view :dashboardId="dashboard.id" :lastCheckFailedAnswers="lastCheckFailedAnswers" v-on:refresh="onFailedAnswersRefresh">
      </failed-answers-view>
    </div>

    <div v-if="show === 'Weekly'" class="stats-container">
      <weekly-scores-view :dashboardId="dashboard.id" v-on:refresh="onWeeklyScoresRefresh">
      </weekly-scores-view>
    </div>
...
@Component({
  components: { GlobalStatsView, DifficultQuestionsView, WeeklyScoresView , FailedAnswersView},
})
